...
def get_args():
    ...
    psr.add_argument("--model-name", type=str, default="fully_connected", choices = ["fully_connected", "basic_cnn", "AlexNet", "Xception", "Inception", "ResNet"], help="Model name (in models.py)")
