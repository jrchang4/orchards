...
DATA_PATH = '../test/' #replace ctoups22 with your own user / data path
FORESTS_PATH = os.path.join(DATA_PATH, "ImagesGoogleMapsForests")
ORCHARDS_PATH = os.path.join(DATA_PATH, "ImagesGoogleMapsOrchards")
FORESTS_TIF_PATH = os.path.join(DATA_PATH, "planetImageryCentroidForests")
ORCHARDS_TIF_PATH = os.path.join(DATA_PATH, "planetImageryCentroidOrchards")
random.seed(25)
...
#for orchards: 
    test_image_paths = ['way550269501.tif']
