...
path = Path("../test/data2/test/planetImageryCentroidForest").rglob("*.tif")
out_path = "../planetSplit/test/planetImageryForestsGreater2Hect/"
...
path = Path("../test/data2/train/planetImageryCentroidForests").rglob("*.tif")
out_path = "../planetSplit/train/planetImageryForestsGreater2Hect/"
for img_p in path:
    #if str(img_p[36:-4]) < 'way308294349':
    #    if img_p[36] != 'r':
...
path = Path("../test/PlanetNewImagery/val/planetImageryForestsGreater2Hect").rglob("*.tif")
out_path = "../planetSplit/val/planetImageryForestsGreater2Hect/" 
for img_p in path:
    #if str(img_p[36:-4]) < 'way308294349':
    #    if img_p[36] != 'r':
    #        continue
    m1img_out_path = out_path +  str(img_p)[64:-4]+'m1'+str(img_p)[-4:]
