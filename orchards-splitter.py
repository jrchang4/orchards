...
path = Path("../test/PlanetNewImagery/test/planetImageryOrchardsGreater2Hect").rglob("*.tif")
out_path = "../planetSplit/test/planetImageryOrchardsGreater2Hect/" 
for img_p in path:
    #if str(img_p[36:-4]) < 'way308294349':
    #    if img_p[36] != 'r':
    #        continue
    m1img_out_path = out_path +  str(img_p)[65:-4]+'m1'+str(img_p)[-4:]
...
print('finished test Orchards')

path = Path("../test/PlanetNewImagery/train/planetImageryOrchardsGreater2Hect").rglob("*.tif")
...
print('finished train set orchards')
    

path = Path("../test/PlanetNewImagery/val/planetImageryOrchardsGreater2Hect").rglob("*.tif")
